...
import (
	"bingo-example/http/requests/validators"
...
func VerifyCodePhone(ctx *gin.Context, data interface{}) map[string][]string {
...
func VerifyCodeEmail(ctx *gin.Context, data interface{}) map[string][]string {
